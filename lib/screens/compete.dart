      ...
      appBar: AppBar(
        systemOverlayStyle: SystemUiOverlayStyle(
            ...
            statusBarIconBrightness: themeProvider.selectedTheme == 'dark'
                ? Brightness.light
                : Brightness.dark),
        backgroundColor: themeProvider.selectedTheme == 'dark' ? Color(
            0xFF121212) : Colors.yellow,
        title: Text('Select a Category', style: TextStyle(
            color:
            themeProvider.selectedTheme == 'dark' ? Color(0xFFFFFD00) : Colors
                .grey.shade800,
            fontFamily:
            'Poppins',
            fontWeight:
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      DetailsEntryScreen(category: categories[index] ['name']),
                ),
              );
            },
            child: Container(
                                ...
                                children: [
                                  Icon(Icons.person,
                                    color: themeProvider.selectedTheme == 'dark'
                                        ? Colors.yellow
                                        : Colors.black,),
                                  Text(categories[index]["num"].toString(),
                                    style: TextStyle(
                                        color: themeProvider.selectedTheme ==
                                            'dark' ? Colors.yellow : Colors
                                            .black),),
                                ],
                              ),
                            ],
