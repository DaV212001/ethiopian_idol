...
final GlobalKey<_ProfileScreenState> _profileScreenKey =
                ...
                children: [
                  Row(children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                            firstName, // display the first name of the logged-in user
                            style: TextStyle(
                                color: themeProvider.selectedTheme == 'dark'
                                    ? Colors.white
                        ...
                        Text(
                            phoneNumber, // display the phone number of the logged-in user if their status is "contestant"
                            style: TextStyle(
                                color: themeProvider.selectedTheme == 'dark'
                                    ? Colors.white
                                    : Colors.grey.shade800,
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  if (index == items.length) {
                    ...
                    } else if (items[index]['text'] == "Fill Wallet") {
                      // add a onTap function to navigate to the ChangeProfileScreen
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            ChapaWalletFillerScreen()))
                                .then((value) => _getWalletBalance());
                          },
                        ),
                        Container(
                            child: Text(
                          'Wallet Balance : $walletBalance ETB',
                          style: TextStyle(
                              color: themeProvider.selectedTheme == 'dark'
                                  ? Colors.white
                                  : Colors.black),
    ...
    return IconButton(
      ...
      onPressed: () {
        ...
        themeProvider.setSelectedTheme(
            themeProvider.selectedTheme == 'dark' ? 'light' : 'dark');
        themeProvider.selectedTheme == 'dark'
            ? _controller.forward()
            : _controller.reverse();
      },
